...
fenouil = bapt.vegetable_processes.create!(kind:'fenouil', climate: '10-20°C', environment:'indoor', maturation_length: 18, difficulty: 3)
poireaux = coco.vegetable_processes.create!(kind:'poireaux', climate: '0-10°C', environment:'outdoor', maturation_length: 35, difficulty: 4)
